...
def _area_services_build(s, u):
    ...
    if not parts or not area:
        ...
        return (
            "আপনার এলাকার সেবা 🛠️",
            f"{_name(u)}, আপনার আশেপাশে নানা ধরনের সেবা পাওয়া যাচ্ছে — "
    ...
    title = f"{area}-এ আপনার পাশেই সেবা পাবেন 🛠️"
    body = (
        f"{_name(u)}, {area}-এ এখন {listing} সেবা দিচ্ছেন। দরকার হলে এখনই "
        "‘আমার সেবা’ থেকে সরাসরি যোগাযোগ করুন — কাছের ও বিশ্বস্ত সেবা।"
    )
    return (title, body)
...
CATALOG = [
    ...
    Nudge(
        ...
        build=lambda s, u: (
            "ঠিকানা যোগ করুন 📍",
            "{}, আপনার এলাকা যোগ করুন — তাহলে আপনার আশেপাশে কারা সেবা দিচ্ছেন "
