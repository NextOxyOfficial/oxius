...
from django.db.models import Count, Q,OuterRef, Subquery, Case, When, IntegerField, Value
import base64
    ...
    def get_queryset(self):
        ...
        queryset = BusinessNetworkPost.objects.annotate(
            priority=Case(
                ...
                # Priority 3: Posts from users who are following me
                ...
                # Priority 5: Posts from users in nearby cities
                When(author_id__in=Subquery(nearby_users_subquery), then=Value(5)),
                # Default: Other posts (lowest priority)
                default=Value(6),
            ...
            'priority',  # First by priority (1-6)
            '-created_at'  # Then by newest within each priority
        )
