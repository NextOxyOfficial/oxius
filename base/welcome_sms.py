...
WELCOME_SMS = [
    "{name}, AdsyClub-এ স্বাগতম! সেবা নিন-দিন, নেটওয়ার্ক গড়ুন আর MicroGigs সহ মার্কেটপ্লেসে কাজ করে আয় করুন। শুভকামনা রইলো।",
    "প্রিয় {name}, AdsyClub পরিবারে আপনাকে স্বাগতম! কেনাবেচা, ফ্রিল্যান্সিং আর কাজের মাধ্যমে আয় — সবকিছু আজই শুরু করুন।",
    "{name}, আপনার AdsyClub অ্যাকাউন্ট প্রস্তুত! আপনার দক্ষতা কাজে লাগিয়ে মার্কেটপ্লেসে আয় শুরু করুন। শুভকামনা রইলো।",
    "স্বাগতম {name}! AdsyClub-এ eShop, Workspace, MicroGigs সহ কাজ করে আয়ের অসংখ্য সুযোগ পাবেন। আজই ঘুরে দেখুন।",
    "{name}, AdsyClub-এ রেজিস্ট্রেশন করায় ধন্যবাদ! মানুষের সাথে কানেক্ট হোন আর MicroGigs সহ অন্যান্য মার্কেটপ্লেসে কাজের মাধ্যমে প্রতিদিন আয় করুন।",
    "হ্যালো {name}, AdsyClub-এ আপনার যাত্রা শুরু! পণ্য বিক্রি, ফ্রিল্যান্স কাজ বা সেবা — সব এক জায়গায়। এগিয়ে যান।",
    "{name}, আপনাকে AdsyClub-এ পেয়ে আমরা আনন্দিত! কাজের মাধ্যমে আয়, সেবা আর নেটওয়ার্কিং এখন আপনার হাতের মুঠোয়।",
    "প্রিয় {name}, AdsyClub-এ স্বাগতম! আপনার দক্ষতা কাজে লাগিয়ে মার্কেটপ্লেসে আয় করুন, বিশ্বস্ত সেবা খুঁজে নিন। ভালো থাকুন।",
    "{name}, AdsyClub পরিবারে আপনি এখন একজন! MicroGigs-এর ছোট কাজ থেকে নিজের ব্যবসা — আয়ের পথ এখন খোলা। শুরু করুন।",
    "স্বাগতম {name}! AdsyClub-এ কেনাকাটা, রাইড, ফ্রিল্যান্সিং আর কাজের মাধ্যমে আয় — সব একসাথে। আপনার সফলতা কামনা করি।",
]
