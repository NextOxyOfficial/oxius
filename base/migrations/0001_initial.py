    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality', models.CharField(choices=[('wifi', 'WiFi'), ('cellular', 'Cellular')], max_length=10)),
                ('target_country', models.CharField(choices=[('bangladesh', 'Bangladesh')], default='bangladesh', max_length=10)),
                ('target_device', models.CharField(choices=[('all', 'All'), ('iphone', 'iPhone'), ('android', 'Android'), ('windows', 'Windows'), ('linux', 'Linux')], default='all', max_length=10)),
