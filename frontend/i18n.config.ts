export default defineI18nConfig(() => ({
  ...
  locale: "en",  messages: {
    en: {
      ...
      // got_it: "Got It",
      all_over_bangladesh: "All Over Bangladesh",      sale_listing: "Sale Listings",
      mindforce: "Mindforce",
      ...
      video_lessons_desc: "Interactive educational content for your selected subject",
      ...
      class_11_12: "Class 11-12",      all_lessons: "All Lessons",
      filter_by: "Filter by",
      search: "Search",
      search_placeholder: "Search in all lessons...",
      loading: "Loading...",
      try_again: "Try Again",
      selected: "Selected",
      ...
      getting_started_desc: "Start by selecting your batch (SSC or HSC) from above. Then follow the steps to find your subject and video lessons.",
    ...
    bn: {
      ...
      shastho_sheba: "স্বাস্থ্য সেবা",      bill_pay: "বিল পে",
      adsy_pay: "অ্যাডজি পে",
      ...
      interactive_education: "এসএসসি এবং এইচএসসি ছাত্রদের জন্য ইন্টারেক্টিভ শিক্ষা",
      video_lessons_desc: "ইন্টারেক্টিভ শিক্ষামূলক বিষয়বস্তু আপনার নির্বাচিত বিষয়ের জন্য",
      step_1_of_4: "ধাপ ১ / ৪",
      step_2_of_4: "ধাপ ২ / ৪",
      step_3_of_4: "ধাপ ৩ / ৪", 
      step_4_of_4: "ধাপ ৪ / ৪",
      ...
      search: "অনুসন্ধান",
      search_placeholder: "সমস্ত পাঠের মধ্যে অনুসন্ধান করুন...", 
      loading: "লোড হচ্ছে...",
      ...
      chemistry: "রসায়ন",
      biology: "জীববিজ্ঞান",      mathematics: "গণিত",
      filter_and_search: "ফিল্টার এবং অনুসন্ধান বিকল্প",
      learn_at_your_pace: "আপনার নিজের গতিতে শিখুন",
      description: "বিবরণ",getting_started_desc: "উপরে থেকে আপনার ব্যাচ (এসএসসি বা এইচএসসি) নির্বাচন করে শুরু করুন। তারপর আপনার বিষয় এবং ভিডিও লেসনগুলি খুঁজে পেতে পদক্ষেপগুলি অনুসরণ করুন।",
      no_subjects_found: "এই বিভাগের জন্য কোন বিষয় পাওয়া যায়নি",
      no_videos_found: "এই বিষয়ের জন্য কোন ভিডিও পাওয়া যায়নি",
      no_search_results: "আপনার অনুসন্ধান মানদণ্ডের সাথে মেলে এমন কোন ফলাফল নেই",
