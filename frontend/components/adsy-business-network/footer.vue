      ...
      >
        <div class="relative">
          <div class="icon-wrapper">
            <BarChart2
              class="h-6 w-6 mb-1 transition-all duration-300 ease-out group-hover:scale-110 drop-shadow-sm"
              :class="$route.path === '/' ? 'text-green-100/30' : 'text-gray-500'"
            />
      ...
      >
        <div class="relative">
          <div class="icon-wrapper">
            <Newspaper
              class="h-6 w-6 mb-1 transition-all duration-300 ease-out group-hover:scale-110 drop-shadow-sm"
              :class="$route.path === '/adsy-news' ? 'text-orange-100/30' : 'text-gray-500'"
            />
      ...
      >
        <div class="relative">
          <div class="icon-wrapper">
            <Clock
              class="h-6 w-6 mb-1 transition-all duration-300 ease-out group-hover:scale-110 drop-shadow-sm"
              :class="$route.path === '/business-network' ? 'text-blue-100/30' : 'text-gray-500'"
            />
            <div v-if="$route.path === '/business-network'" class="icon-gradient-blue"></div>
            <div class="icon-reflection"></div>
          </div>
        ...
        <div class="relative">
          <div class="icon-wrapper">
            <UIcon
              ...
              class="h-6 w-6 mb-1 transition-all duration-300 ease-out group-hover:scale-110 drop-shadow-sm"
              :class="$route.path === '/auth/login' ? 'text-purple-100/30' : 'text-gray-500'"
            />
        ...
        <div class="relative">
          <div class="icon-wrapper">
            <UIcon
              ...
              class="h-6 w-6 mb-1 transition-all duration-300 ease-out group-hover:scale-110 drop-shadow-sm"
              :class="$route.path === '/#micro-gigs' ? 'text-amber-100/30' : 'text-gray-500'"
            />
