<template>
  <div class="user-sponsors-section">
    ...
    <div v-if="loading" class="text-center py-8">
      <div
        class="animate-spin rounded-full h-8 w-8 border-b-2 border-yellow-500 mx-auto"
      ></div>
      ...
      >
        ...
        <div class="flex items-start justify-between mb-3">
          <div class="flex items-center space-x-3">
            ...
            <div
              v-else
              class="w-10 h-10 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-lg flex items-center justify-center"
            >
            ...
            <div>
              ...
              >
                <span
                  ...
                  :class="getStatusDotClass(sponsor.status)"
                ></span>
          ...
          <div
            class="relative"
            v-click-outside="() => closeActionsMenu(sponsor.id)"
          >
            <button
...
const confirmDelete = async () => {
  ...
  try {
    ...
    try {
      ...
      sponsors.value = sponsors.value.filter(
        (s) => s.id !== deletingSponsor.value.id
      );
    ...
    toast.error(
      `Failed to delete sponsor: ${error.message || "Unknown error"}`
    );
  } finally {
...
const toggleActionsMenu = (sponsorId) => {
  activeActionMenu.value =
    activeActionMenu.value === sponsorId ? null : sponsorId;
};
