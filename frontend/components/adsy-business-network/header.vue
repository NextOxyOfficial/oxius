      ...
      <div class="max-w-5xl mx-auto px-3 sm:px-4">
        <div class="flex items-center justify-between h-16 sm:h-18">
          ...
          <div class="flex items-center sm:gap-5">
            ...
            >
              <div class="flex flex-col justify-center items-center w-5 space-y-1.5 transform transition-all duration-300">
                <span class="block h-0.5 w-5 bg-gray-600 dark:bg-gray-300 transform transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-400"></span>
                <span class="block h-0.5 w-3.5 bg-gray-600 dark:bg-gray-300 transform transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-400 group-hover:w-5"></span>
                <span class="block h-0.5 w-5 bg-gray-600 dark:bg-gray-300 transform transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-400"></span>
              </div>
              
              <!-- Ripple effect on click -->
              <span class="absolute inset-0 rounded-full transform scale-0 bg-blue-100 dark:bg-blue-900/40 animate-ripple"></span>
            </button>
            ...
            >
              <div class="relative">
                <NuxtImg
                  ...
                  loading="eager"
                />
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 hover:opacity-100 -translate-x-full hover:translate-x-full transition-all duration-1000 ease-in-out"></div>
              </div>
            </NuxtLink>
          </div>
          ...
          <div class="flex items-center gap-1 sm:gap-3">
            ...
            <div class="relative search-button-container">
              <button
                ...
                aria-label="Search"
              >
                <SearchIcon class="h-[18px] w-[18px] text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" />
              </button>
                  ...
                  >
                    ...
                    >
                      ...
                      <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        <span class="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full text-xs">
            ...
            <div class="hidden sm:flex items-center gap-2">
              ...
              >
                <div class="p-1 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white transition-transform group-hover:scale-110 group-hover:rotate-3">
                  <BarChartBig class="h-3.5 w-3.5" />
                </div>
                <span class="relative overflow-hidden">
                  AdsyClub
                  <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500 transform scale-x-0 origin-left transition-transform group-hover:scale-x-100"></span>
                </span>
              </NuxtLink>
              ...
              >
                <div class="p-1 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 text-white transition-transform group-hover:scale-110 group-hover:rotate-3">
                  <Newspaper class="h-3.5 w-3.5" />
                </div>
                <span class="relative overflow-hidden">
                  AdsyNews
                  <span class="absolute bottom-0 left-0 w-full h-0.5 bg-orange-500 transform scale-x-0 origin-left transition-transform group-hover:scale-x-100"></span>
                </span>
              </NuxtLink>
            </div>
