<template>
  <Teleport to="body">
    <div
      ...
      :class="{ 'animate-fade-in': modelValue }"
            ...
            <div class="flex flex-col px-6 py-5 space-y-5">
              ...
              <div class="space-y-2">
                ...
                <textarea
                  ...
                  rows="5"
                  class="flex w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm ring-offset-background placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-blue-400 dark:focus:border-blue-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-400 dark:focus-visible:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50 min-h-[120px] transition-all shadow-sm resize-none"
                ></textarea>
              </div>
              ...
              <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-3 mt-1">
                  <div
                    ...
                    :class="[
                      'flex items-center space-x-2 px-4 py-3 rounded-lg border cursor-pointer transition-all col-span-2 sm:col-span-1',
                  ...
                  <div
                    ...
                    :class="[
                      'flex items-center space-x-2 p-3 rounded-lg border cursor-pointer transition-all col-span-2 sm:col-span-1',
