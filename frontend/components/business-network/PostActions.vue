  ...
  >
    ...
    <div class="flex items-center space-x-4">
      ...
      <div class="flex items-center group">        <button
        ...
        <span 
          @click="$emit('open-comments-modal', post)" 
          class="text-base ml-1 text-gray-500 dark:text-gray-500 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400"
        >
        ...
        >
          <div class="relative">
            <UIcon
              ...
              class="size-5 text-gray-500 dark:text-gray-500 group-hover:text-emerald-600 dark:group-hover:text-emerald-500 transition-colors"
            />
          </div>
        </button>
      </div>
