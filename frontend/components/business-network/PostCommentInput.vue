<template>
  <div class="flex items-center gap-2.5 mt-4 pt-3 border-t border-gray-100/60 dark:border-slate-700/40 px-2">
    ...
    <div class="relative group">
      ...
      <div class="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-blue-500/10 blur-md -z-10"></div>
    </div>
    ...
    <div class="flex-1 relative">
      <div class="relative group">
        ...
        <div class="absolute bottom-0 left-4 right-4 h-0.5 bg-gradient-to-r from-blue-500/0 via-blue-500/50 to-blue-500/0 transform scale-x-0 group-focus-within:scale-x-100 transition-transform duration-300"></div>
      </div>
      ...
      >
        ...
        >
          ...
          <!-- Subtle glow effect -->
          <div class="absolute inset-0 rounded-full bg-blue-400/50 blur-md opacity-0 hover:opacity-60 transition-opacity duration-300 -z-10"></div>
        </button>
      </div>
      ...
      >
        <div class="pt-1 pb-1">
          ...
          <div class="px-3 py-1.5 text-xs font-medium text-gray-500 dark:text-gray-400 border-b border-gray-100/80 dark:border-slate-700/80">
            Mention someone
          </div>
          ...
          <div class="py-1">
            ...
            >
              ...
              <div class="flex flex-col">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400" v-if="user?.follower_details?.profession">
