  ...
  >
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
      <div class="flex items-center">
        ...
        <div class="ml-3 block md:hidden md:group-hover/sidebar:block transition-all duration-300">
          <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Alex Johnson</h3>
          <p class="text-xs text-green-500">Online</p>
        </div>
      </div>
      <div class="flex space-x-2 block md:hidden md:group-hover/sidebar:flex">
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
      <div class="relative block md:hidden md:group-hover/sidebar:block">
      ...
      <div class="hidden md:block md:group-hover/sidebar:hidden flex justify-center">
        <button class="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition">
    ...
    <div class="flex-1 overflow-y-auto">
      <div class="py-2">
        ...
        >
          ...
          <div class="ml-3 flex-1 overflow-hidden block md:hidden md:group-hover/sidebar:block">
        ...
        <div v-if="isSearching" class="flex justify-center items-center py-8 block md:hidden md:group-hover/sidebar:flex">
          <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-primary-500"></div>
        </div>

        <!-- No results state -->
        <div v-else-if="searchQuery && filteredChats.length === 0" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400 block md:hidden md:group-hover/sidebar:block">
          No chats found
        </div>

        <!-- Groups -->
        <div v-else>
          <h4 class="px-4 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase block md:hidden md:group-hover/sidebar:block">Groups</h4>
          ...
          <!-- Friends -->
          <h4 class="px-4 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase block md:hidden md:group-hover/sidebar:block mt-4">Friends</h4>
          <div 
        ...
        <div v-if="isLoadingMore" class="flex justify-center items-center py-4 block md:hidden md:group-hover/sidebar:flex">
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-700">
      <div class="flex space-x-2">
        ...
        >
          ...
          <span class="block md:hidden md:group-hover/sidebar:inline-block text-sm">Chat</span>
        </button>
        <button 
        ...
        >
          ...
          <span class="block md:hidden md:group-hover/sidebar:inline-block text-sm">Group</span>
        </button>
      </div>
    </div>
  </div>
