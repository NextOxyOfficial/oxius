<template>
    <div>
      ...
      <div 
        v-if="showChat" 
        class="fixed z-[999] max-sm:inset-0 max-sm:h-screen bottom-0 sm:bottom-[90px] right-5 z-40 sm:w-[95%] md:w-[400px] lg:w-[450px] sm:h-[600px] sm:max-h-[80vh] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-500 transform"
        :class="{ 
