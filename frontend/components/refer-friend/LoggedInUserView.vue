  ...
  <div class="py-12 px-4 relative">
    ...
    <div class="container mx-auto max-w-4xl">
        ...
        <UCard>
          ...
          <div class="space-y-6">
            ...
            <div class="text-center">
              ...
              <p class="text-xs text-gray-500 mt-2">Scan to open referral link</p>
            </div>
            ...
            <div>
              ...
              <div class="grid grid-cols-4 gap-3">
                ...
                >
                  <UIcon name="i-mdi:facebook" class="text-2xl text-blue-600" />
                ...
                >
                  <UIcon name="i-mdi:twitter" class="text-2xl text-blue-400" />
      ...
      <div class="mt-8 mb-8">
        ...
        <div v-if="isLoadingCommissions" class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div v-for="i in 3" :key="i" class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          >
            <div class="flex items-center justify-between mb-4">
              <div class="flex items-center">
                <div
                  ...
                  :class="{
                    ...
                    'bg-purple-100 dark:bg-purple-900/50': service.color === 'purple',
                    'bg-yellow-100 dark:bg-yellow-900/50': service.color === 'yellow'
                  }"
                >
                  <UIcon
                    :name="service.icon"
                    :class="{
                      'text-lg text-blue-600 dark:text-blue-400': service.color === 'blue',
                      'text-lg text-purple-600 dark:text-purple-400': service.color === 'purple',
                      'text-lg text-yellow-600 dark:text-yellow-400': service.color === 'yellow'
                    }"
                  />
                </div>
                <div class="ml-3">
              ...
              <UBadge
                ...
                size="sm"
              >
                {{ service.count }} {{ service.count === 1 ? 'referral' : 'referrals' }}
              </UBadge>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-xs text-gray-500 dark:text-gray-400">Total Earned</span>
              <div class="text-lg font-semibold text-gray-700 dark:text-white flex items-center">
      ...
      </div>      <!-- Getting Started Guide for new users -->
      <div v-if="!isLoadingCommissions && commissionData.total_commissions === 0" class="mt-8 mb-8">
        <div class="bg-gradient-to-r from-primary-50 to-blue-50 dark:from-primary-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-primary-200 dark:border-primary-800">
          <div class="flex items-start">
            <div class="flex-shrink-0">
              <UIcon name="i-heroicons-light-bulb" class="text-primary-600 dark:text-primary-400 text-2xl" />
            </div>
            <div class="ml-4 flex-1">
              ...
              <p class="text-primary-700 dark:text-primary-300 mb-4">
                You haven't made any referrals yet. Start earning commissions by sharing your referral link with friends and family.
              </p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              ...
              <UIcon name="i-heroicons-chart-bar" class="text-blue-500 text-xl" />
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-xs text-gray-500 dark:text-gray-400">Avg Commission</p>
                <p class="text-lg font-semibold text-gray-700 dark:text-white">
                  ৳{{ averageCommission.toFixed(2) }}
                </p>
              </div>
              <UIcon name="i-heroicons-calculator" class="text-blue-500 text-xl" />
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-xs text-gray-500 dark:text-gray-400">Best Performing</p>
                <p class="text-lg font-semibold text-gray-700 dark:text-white">
                  {{ bestPerformingService }}
                </p>
              </div>
              <UIcon name="i-heroicons-trophy" class="text-yellow-500 text-xl" />
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              ...
              <UIcon name="i-heroicons-calendar" class="text-green-500 text-xl" />
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-lg font-semibold" :class="growthRate >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                  {{ growthRate >= 0 ? '+' : '' }}{{ growthRate.toFixed(1) }}%
                </p>
              </div>
              <UIcon :name="growthRate >= 0 ? 'i-heroicons-arrow-trending-up' : 'i-heroicons-arrow-trending-down'" 
        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-2">
              <UButton
                :loading="activeTab === 0 ? isLoadingCommissions : isLoadingUsers"
                @click="activeTab === 0 ? getCommissionHistory() : getReferredUsers()"
                color="gray"
                variant="ghost"
                size="sm"
            ...
            >
              <div class="overflow-x-auto">
                ...
                >
                  ...
                  >
                    <!-- Loading Skeleton -->
                    <tr v-if="isLoadingCommissions" v-for="i in 5" :key="'loading-' + i" class="animate-pulse">
                    ...
                    >
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <UBadge
                          :color="getServiceTypeColor(earning.type_code || 'gig_completion')"
                          variant="soft"
                          size="sm"
                        >
                          {{ earning.task }}
                    ...
                    <tr v-if="!isLoadingCommissions && filteredEarnings.length === 0">
                      <td
                        colspan="5"
