          ...
          >
            ...
            >
              ...
              <div class="aspect-square relative overflow-hidden group">
                ...
                >
                  <button
                    class="px-2 py-1 bg-white/90 dark:bg-slate-800/90 text-xs font-medium text-gray-800 dark:text-white rounded-md shadow-sm transform transition-all hover:scale-105"
