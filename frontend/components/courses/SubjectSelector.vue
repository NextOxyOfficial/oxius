  ...
  <div v-if="division" class="bg-white rounded-lg shadow-md p-4 mt-3">
    <div class="flex items-center justify-between mb-3">
      <div class="flex items-center">
        ...
        <h2 class="text-lg font-bold">Select Your Subject</h2>
      </div>
      ...
      <div class="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
      <div 
      ...
      >        <!-- Responsive layout for subject cards -->
        <div class="flex flex-col sm:flex-row items-center p-2 sm:p-3">
          ...
          <div class="p-1.5 rounded-lg mb-1 sm:mb-0 sm:mr-2" :class="subject.bgColor">
            <img v-if="subject.icon" :src="subject.icon" class="w-5 h-5" alt="Subject Icon" />
        ...
        </div>        <div v-if="selectedSubject === subject.id" class="bg-blue-50 py-1 px-2 text-xs text-blue-600 border-t border-blue-200 flex items-center justify-center">
