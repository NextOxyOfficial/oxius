    ...
    <div class="relative z-10">
      ...
      <section class="mb-4 mt-6 relative">
        ...
        <div class="relative overflow-hidden">
          <div ref="arrivalsContainer" class="flex space-x-2 overflow-x-auto pb-4 pt-2 px-2 -mx-2 hide-scrollbar snap-x snap-mandatory arrivals-container">
...
import HotDealsSection from './HotDealsSection.vue';
...
onMounted(() => {
  ...
  if (arrivalsContainer.value) {
    ...
    arrivalsContainer.value.addEventListener('mousedown', startDrag, { passive: false });
    document.addEventListener('mousemove', onDrag, { passive: false });
    document.addEventListener('mouseup', endDrag, { passive: true });
    arrivalsContainer.value.addEventListener('mouseleave', endDrag, { passive: true });
  }
});
