      ...
      <div class="container mx-auto px-4 py-16 md:py-24">
        ...
        <div class="max-w-6xl mx-auto mb-20">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <!-- Testimonial 1 -->
            <div
              class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700 testimonial-card"
            >
              <div class="flex items-center mb-4">
                <div
                  class="h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900/50 flex items-center justify-center text-primary-700 dark:text-primary-300 font-bold text-xl mr-4"
                >
                  R
                </div>
                <div>
              ...
              <p class="text-gray-600 dark:text-gray-300">
                "I've earned over ৳4,500 in just two months by sharing my
                referral link with friends. The process is super simple and the
                payouts are prompt!"
              </p>
              <div class="mt-4 flex">
            ...
            >
              ...
              <p class="text-gray-600 dark:text-gray-300">
                "I shared my link in my WhatsApp groups and started earning
                commissions right away. It's been a great way to make some extra
                income on the side!"
              </p>
              <div class="mt-4 flex">
                <UIcon name="i-heroicons-star" class="text-amber-400" />
                ...
                <UIcon name="i-heroicons-star" class="text-amber-400" />
                <UIcon name="i-heroicons-star" class="text-amber-400" />
                <UIcon name="i-heroicons-star-half" class="text-amber-400" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto mb-20">
          ...
          <UAccordion :items="faqItems" class="faq-accordion" />
        </div>
