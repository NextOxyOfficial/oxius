...
<UContainer>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="space-y-3">
      ...
      <div v-if="!selectedBatch" class="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
