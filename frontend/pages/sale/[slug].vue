  ...
  <div class="bg-gray-100 min-h-screen product-detail-page">
    ...
    <UContainer class="py-4">
      ...
      >
        ...
        <div
          class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-primary-400 to-transparent loading-progress"
        ></div>
        <div
          class="absolute -left-10 -top-10 w-40 h-40 bg-primary-50 rounded-full blur-3xl opacity-30"
        ></div>
        <div
          class="absolute -right-10 -bottom-10 w-40 h-40 bg-blue-50 rounded-full blur-3xl opacity-30"
        ></div>
        ...
        <div class="flex flex-col items-center justify-center relative z-10">
          ...
          <div class="loading-animation">
            <div class="w-24 h-24 relative">
              <div
                class="w-full h-full rounded-full border-4 border-gray-100"
              ></div>
              <div
                class="w-full h-full rounded-full border-4 border-t-primary-500 border-r-primary-400 border-b-primary-300 animate-spin absolute top-0 left-0"
              ></div>
              <div class="absolute inset-0 flex items-center justify-center">
                <div class="relative">
                  <UIcon
                    name="i-heroicons-shopping-bag"
                    class="size-10 text-primary-400"
                  />
                  <span
                    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-white rounded-full animate-ping"
                  ></span>
                </div>
              </div>
            </div>
          ...
          <div class="mt-8 flex flex-col items-center space-y-3 w-64">
            <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
              <div
                class="h-full bg-gradient-to-r from-primary-300 to-primary-500 w-3/4 animate-pulse-width"
              ></div>
            </div>
            <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
              <div
                class="h-full bg-gradient-to-r from-primary-300 to-primary-500 w-1/2 animate-pulse-width delay-150"
              ></div>
            </div>
            <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
              <div
                class="h-full bg-gradient-to-r from-primary-300 to-primary-500 w-1/4 animate-pulse-width delay-300"
              ></div>
            </div>
          </div>
        </div>
      ...
      >
        <div
          class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-red-300 to-transparent"
        ></div>
        <div
          class="absolute -left-20 -top-20 w-60 h-60 bg-red-50 rounded-full blur-3xl opacity-30"
        ></div>
        <div
          class="absolute -right-20 -bottom-20 w-60 h-60 bg-amber-50 rounded-full blur-3xl opacity-30"
        ></div>
        ...
        <div class="max-w-md mx-auto px-6 relative z-10">
          ...
          <div class="error-animation mb-8 relative">
            <div
              class="bg-amber-50 w-32 h-32 rounded-full mx-auto flex items-center justify-center border-4 border-amber-100"
            >
              <UIcon
            ...
            <div
              class="absolute w-full h-full top-0 left-0 bg-amber-50 rounded-full animate-ping-slow opacity-30"
            ></div>
          </div>

          <h3
            class="text-2xl font-bold text-gray-800 mb-3 animate-fade-in"
            style="--delay: 200ms"
          >
          ...
          <p
            class="mt-4 text-gray-600 text-lg mb-8 leading-relaxed animate-fade-in"
            style="--delay: 300ms"
          >
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="bg-white border border-gray-200 mb-3" id="product-title">
            <div class="p-4">
              ...
              <div class="flex flex-wrap gap-2 text-sm text-gray-500">
                ...
                <span
                  v-if="post.area || post.district"
                  class="flex items-center"
                >
                  <UIcon name="i-heroicons-map-pin" class="size-3.5 mr-1" />
                  {{ post.area }}{{ post.area && post.district ? ", " : ""
                  }}{{ post.district }}
                </span>
              </div>
            </div>
          </div>
          <!-- Mudah.my Style Images Gallery Card -->
          <div
            class="bg-white border border-gray-200 mb-6 slide-up-fade-in"
            style="--delay: 300ms"
          >
            ...
            >
              ...
              <div
                class="h-full w-full flex items-center justify-center overflow-hidden image-container bg-gray-50"
              >
                <img
              ...
              <!-- Mudah.my Style Navigation Controls -->
              <div
            ...
            <!-- Mudah.my Style Thumbnails Gallery -->
            <div
              v-if="post.images && post.images.length > 1"
          ...
          <!-- Removed separate location section as per Mudah.my style - information moved to title section -->
          ...
          <div
            class="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden mb-6 slide-up-fade-in"
            style="--delay: 500ms"
          >
            <!-- Mudah.my Style Header -->
            <div class="bg-gray-100 p-2.5 border-b border-gray-200">
              <h3
                class="text-sm uppercase font-semibold text-gray-800 flex items-center"
              >
                <UIcon
                  name="i-heroicons-clipboard-document-list"
                  class="size-4 mr-1.5 text-gray-700"
                />
                Product Details
              </h3>
            </div>
            ...
            <div class="p-6">
              <div class="grid grid-cols-1 gap-y-3">
                ...
                <div
                  class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                >
                  <div class="w-1/3 text-xs text-gray-500">Category</div>
                ...
                <div
                  class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                >
                  <div class="w-1/3 text-xs text-gray-500">Condition</div>
                  <div class="w-2/3 text-sm text-gray-800">
                ...
                <template v-if="post.category === 1">
                  <div
                    v-if="post.property_type"
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Property Type</div>
                    <div class="w-2/3 text-sm text-gray-800">
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Size</div>
                    <div class="w-2/3 text-sm text-gray-800">
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Bedrooms</div>
                    <div class="w-2/3 text-sm text-gray-800">
                      {{ post.bedrooms }}
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Bathrooms</div>
                    <div class="w-2/3 text-sm text-gray-800">
                      {{ post.bathrooms }}
                    </div>
                  </div>
                ...
                <template v-if="post.category === 2">
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Make</div>
                    <div class="w-2/3 text-sm text-gray-800">
                      {{ post.make }}
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Model</div>
                    <div class="w-2/3 text-sm text-gray-800">
                      {{ post.model }}
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Year</div>
                    <div class="w-2/3 text-sm text-gray-800">
                      {{ post.year }}
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Mileage</div>
                    <div class="w-2/3 text-sm text-gray-800">
                ...
                <template v-if="post.category === 3">
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Brand</div>
                    <div class="w-2/3 text-sm text-gray-800">
                      {{ post.brand }}
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                  >
                    <div class="w-1/3 text-xs text-gray-500">Warranty</div>
                    <div class="w-2/3 text-sm text-gray-800">
                ...
                <div
                  ...
                  class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                >
                  <div class="w-1/3 text-xs text-gray-500">Location</div>
                  <div class="w-2/3 text-sm text-gray-800">
                    {{ post.area }}{{ post.area && post.district ? ", " : ""
                    }}{{ post.district }}
                  </div>
                ...
                <div
                  class="flex items-baseline spec-item border-b border-gray-100 pb-2"
                >
                  <div class="w-1/3 text-xs text-gray-500">Posted Date</div>
                  <div class="w-2/3 text-sm text-gray-800">
              ...
              <!-- Mudah.my Style Description Section -->
            ...
            <!-- Mudah.my Style Safety Tips - Much Simpler -->
          ...
          <div class="lg:col-span-1">
            ...
            <div class="bg-white border border-gray-200 mb-6 seller-card">
              ...
              <!-- Mudah.my Style Seller Profile Content -->
              <div class="p-3">
                ...
                <div class="flex items-center mb-3">
                  <div class="mr-3 relative">
                    ...
                    <div
                      v-if="post.seller?.is_verified"
                      class="absolute -bottom-1 -right-1 bg-blue-500 rounded-full p-0.5 border-2 border-white"
                    >
                      <UIcon
                ...
                <div v-if="post.phone" class="mb-3">
                  <div class="flex flex-col space-y-1">
                    <div
                      class="flex items-center justify-between bg-white border border-gray-200 p-2"
                    >
                      <div class="flex items-center">
                        <UIcon
                ...
                <!-- Mudah.my Style Contact Buttons -->
                <div class="space-y-2">
                  <!-- Message Button - Orange color like Mudah.my -->
                  <UButton
                  ...
                  >
                    ...
                    <div class="flex-1">
                      ...
                      <p class="text-orange-600 text-sm font-medium mt-1">
                        <span
                          v-if="relatedPost.negotiable && !relatedPost.price"
                          >Negotiable</span
                        >
            ...
            <div class="bg-white border border-gray-200 p-3 mb-6 text-center">
    ...
    <UModal v-model="showContactForm" :ui="{ width: 'max-w-md' }">
      <div class="bg-white border border-gray-200">
        <!-- Header -->
        <div
          class="flex justify-between items-center bg-gray-100 border-b border-gray-200 p-3"
        >
          ...
          <form @submit.prevent="reportPost">
            <div class="mb-4">
              <label class="block text-sm font-medium text-gray-700 mb-2"
                >Reason for Report <span class="text-red-500">*</span></label
              >
