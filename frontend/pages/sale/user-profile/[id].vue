  ...
  <div>
    ...
    <div class="max-w-6xl mx-auto px-1 py-3">
                  ...
                  <div class="p-2 sm:w-2/3 flex flex-col">
                    ...
                    >
                      <NuxtLink
                        ...
                        class="text-emerald-600 hover:text-emerald-700 text-sm flex items-center"
                        @click="
                          handleButtonClick(`view_details_list_${product.id}`)
                        "
                      >
                        View Details
                        <div
      ...
      <CommonUniversalReportDialog
        ...
        title="Report Seller"
        prompt="Please select a reason for reporting this seller:"
