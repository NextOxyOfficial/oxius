<template>
  ...
  >
    ...
    <div class="relative w-full h-[60vh] overflow-hidden">
      <div
        ref="bannerRef"
        class="absolute inset-0 w-full h-[120%] transition-transform duration-300"
      >
        <div
      ...
      <div
        class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[90%] max-w-4xl z-[999]"
      >
        <div
    ...
    <div class="container mx-auto px-4 pt-32 pb-16">
            ...
            <div class="relative overflow-hidden rounded-full shadow-xl">
              ...
              <div class="relative flex items-center p-1">
                ...
                <input
                  ...
                  class="border-0 bg-transparent focus:ring-0 text-base py-6 px-2 flex-1 placeholder:text-slate-400 focus:outline-none"
                ...
                <button
                  :class="`rounded-full mr-1 transition-all duration-200 text-white px-4 py-2 ${
                    searchFocused
      ...
      >
        ...
        >
          ...
          <button
            class="rounded-full bg-white text-slate-900 hover:bg-slate-100 px-6 py-6 h-auto text-lg font-medium shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 transform group"
          >
            Browse All Products
            <ChevronRight
