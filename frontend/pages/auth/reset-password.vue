              ...
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  ...
                  <ul class="text-xs text-gray-600 space-y-1">
                    <li
                      :class="{
                        'text-green-600': passwordForm.new_password.length >= 8,
                      }"
                    >
...
const handleSendOtp = async () => {
  ...
  try {
    ...
    if (response.data) {
      maskedContact.value =
        response.data.masked_phone || response.data.masked_email;
...
const handleVerifyOtp = async () => {
  ...
  try {
    ...
    error.value =
      "Invalid verification code. Please check your connection and try again.";
  } finally {
    loading.value = false;
  }
};
