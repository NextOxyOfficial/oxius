        ...
        <UTable :columns="columns" :rows="paginatedTransactions">
          <template #type-data="{ row }">
            <div class="flex items-center">
              ...
              <!-- Raise-Up Donation icon -->
              <span
                v-else-if="
                  row.transaction_type?.toLowerCase() === 'raise_up_donation'
                "
              ...
              <!-- Raise-Up Investment icon -->
              <span
                v-else-if="
                  row.transaction_type?.toLowerCase() === 'raise_up_investment'
                "
                class="flex-shrink-0 h-5 w-5 text-purple-500"
              >
                <svg
...
function getTransactionTypeName(transactionType) {
  const typeMap = {
    ...
    raise_up_donation: "Raise-Up Donation",
    raise_up_investment: "Raise-Up Investment",
  };
