            ...
            >
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <span
                    v-else-if="transaction.transaction_type === 'Withdraw'"
                ...
                <span
                  ...
                  :class="{
                    ...
                    'bg-yellow-100 text-yellow-800':
                      transaction.bank_status === 'pending',
                    'bg-red-100 text-red-800':
                      transaction.bank_status === 'failed',
                  }"
                >
                  {{
                    transaction.bank_status.charAt(0).toUpperCase() +
                    transaction.bank_status.slice(1)
                  }}
                </span>
              </td>
              <td
