				...
				<div v-if="currentTab === 3">
					<div class="border-b my-4">
						<UButton
							...
							block
						/>
						<UModal v-model="showQr">
							<div class="px-4 py-12 flex items-center justify-center relative">
								<UButton
