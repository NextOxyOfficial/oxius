/**
 * Enhanced Nuxt.js Plugin for Popup System Integration
 * Place this file in: frontend/plugins/popup-system-enhanced.client.js
 */

export default defineNuxtPlugin(() => {
  if (process.client) {
    class EnhancedNuxtPopupManager {
      constructor() {
        this.popups = [];
    ...
    if (document.readyState === "loading") {
      document.addEventListener("DOMContentLoaded", () => {
        window.enhancedPopupManager = new EnhancedNuxtPopupManager();
      });
    } else {
      window.enhancedPopupManager = new EnhancedNuxtPopupManager();
    }
    ...
    window.addEventListener("beforeunload", () => {
      if (window.enhancedPopupManager) {
        window.enhancedPopupManager.destroy();
      }
    });

    // Export for manual initialization if needed
    window.EnhancedNuxtPopupManager = EnhancedNuxtPopupManager;
  }
});
