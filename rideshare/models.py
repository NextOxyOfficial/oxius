...
class SearchableLocation(models.Model):
    ...
    added_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="rideshare_added_locations",
        help_text="The user who added this location (null if added by admin).",
    )
    payment_transaction = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="rideshare_searchable_location_payments",
        help_text="Payment transaction if this location was added by a user.",
    )
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
