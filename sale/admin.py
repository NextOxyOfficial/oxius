...
class SalePostAdmin(admin.ModelAdmin):
    list_display = ('title', 'user', 'category', 'child_category',
                    'price', 'negotiable', 'status', 'created_at')
    list_filter = ('status', 'category', 'child_category',
                   'condition', 'negotiable', 'created_at', 'condition_object')
...
class SaleImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'post', 'image_preview',
