      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            // Download App Section with dynamic translations
            Container(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              _translationService.t('download_app', fallback: 'Get Our Mobile App!'),
                              style: GoogleFonts.roboto(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                            ...
                            Text(
                              _translationService.t('download_our_app', fallback: 'Experience AdsyClub on the go'),
                              style: GoogleFonts.roboto(
                                fontSize: 12,
                                color: Colors.white.withOpacity(0.9),
                              ),
