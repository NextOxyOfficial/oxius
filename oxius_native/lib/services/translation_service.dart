...
class TranslationService extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localFallbackTranslations = {
    ...
    'bn': {
      ...
      'el_how_body':
          'আগে নিজের ব্যাচটা বাছুন, তারপর বিভাগ আর বিষয় বেছে ছোট করে আনুন — এরপরই সোজা ভিডিও ক্লাসে চলে যান।',
      'el_close': 'বন্ধ করুন',
      'el_change': 'বদলান',
      'el_step': 'ধাপ',
      'el_choose_batch': 'ব্যাচ বাছুন',
      'el_batch_sub': 'আগে নিজের ক্লাসটা বাছুন',
      'el_choose_division': 'বিভাগ বাছুন',
      'el_division_sub': 'সিলেবাসটা ছোট করে আনুন',
      'el_choose_subject': 'বিষয় বাছুন',
